...
# train_length = int(0.8* len(fsl_dataset))
# test_length = len(fsl_dataset) - train_length

# train_dataset, test_dataset = torch.utils.data.random_split(fsl_dataset, (train_length, test_length))
...
train_sampler = TaskSampler(
    fsl_dataset, n_way=N_WAY, n_shot=N_SHOT, n_query=N_QUERY, n_tasks=N_TRAINING_EPISODES
)
